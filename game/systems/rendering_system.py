...
from game.components.text_button import TextButton
        ...
        for entity in entities:
            ...
            if TextButton in entity.components:
                ...
                if not isinstance(batchLayer, Batch):
                    print(f"Ошибка использования слоя для текста {entity.components[TextButton]}: "
                          f"{layer}")
                    continue
                text_button_config = entity.components[TextButton]
